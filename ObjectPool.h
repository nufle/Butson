#ifndef _CLASSE_ObjectPool_
#define _CLASSE_ObjectPool_
#include <stdexcept>
...
public:
	explicit ObjectPool(size_t initialCapacity=100000, size_t maxBlockLength=1000000):
	_firstDeleted(NULL),
	_countInNode(0),
...
const size_t ObjectPool<T,U>::_itemSize = ((sizeof(T) + sizeof(void *)-1) / sizeof(void *)) * sizeof(void *);
